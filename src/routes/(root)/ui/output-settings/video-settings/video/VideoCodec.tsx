          ...
          <motion.div {...slideDownTransition}>
            ...
            >
              <SelectItem
                ...
                endContent={
                  <Tooltip
                    content="当前容器格式的默认编码器"
                    aria-label="当前容器格式的默认编码器"
                  >
                    <Icon
                      name="info"
